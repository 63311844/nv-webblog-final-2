<template>
  <div>
    ...
    <h1>แก้ไขการสั่งซื้ออัลบัม]เพลง{{ blog.id }} </h1><hr>
    ...
    <form class="box1" v-on:submit.prevent="editBlog">
      ...
      <p> รายชื่ออัลบัม]เพลง :
        <select required class="form-control"  v-model="blog.nitem">
                <option>อัลบั้มเลขที่ 1(เสกโลโซ 20ปี)</option>
                      <option>อัลบั้มเลขที่ 2(bodyslam)</option>
                      <option>อัลบั้มเลขที่ 3(mild)</option>
                      <option>อัลบั้มเลขที่ 4(pop)</option>
                      <option>อัลบั้มเลขที่ 5(เสกโลโซ 10ปี)</option>
        </select>
      </p>
      ...
      <p> จำนวนที่ต้องการ : <input type="number" class="form-control" required v-model="blog.pnum" /></p>
            ...
            <p> วันที่สั่งซื้ออัลบั้ลเพลง : <input type="date" required class="form-control" v-model="blog.dates" /></p>
            
            <p> เวลาที่สั่งอัลบัม: <input type="time" required class="form-control" v-model="blog.times" /></p>
