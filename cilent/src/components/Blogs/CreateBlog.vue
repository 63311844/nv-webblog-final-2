      ...
      <b-row class="text-left">
        ...
        <b-col cols="10" class="bg1">
          ...
          <form class="box1" v-on:submit.prevent="createBlog">
            ...
            <p> รายชื่ออัลบั้ลเพลง :
              <select required class="form-control"  v-model="blog.nitem">
                      <option>อัลบัมเลขที่ 1(เสกโลโซ 20ปี)</option>
                      <option>อัลบัมเลขที่ 2(bodyslam)</option>
                      <option>อัลบัมเลขที่ 3(mild)</option>
                      <option>อัลบัมเลขที่ 4(pop)</option>
                      <option>อัลบัมเลขที่ 5(เสกโลโซ 10ปี)</option>
            ...
            <p> เวลาที่สั่งซื้ออัลบั้ลเพลง: <input type="time" required class="form-control" v-model="blog.times" /></p>
