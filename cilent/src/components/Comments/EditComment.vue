...
<!-- add-->
 ...
 <form enctype="multipart/form-data" novalidate>
        <div class="dropbox">
          ...
          <p v-if="isSuccess">อัพโหลดอัลบั้ลเพลงเรียบร้อยแล้ว!.</p>
          <p v-if="isFailed">อัพโหลดกอัลบั้ลเพลงไม่สำเร็จ</p>
        </div>
        ...
        <div>
          <ul class="pictures">
            <li v-for="picture in pictures" v-bind:key="picture.id">
              ...
              <button v-on:click.prevent="delFile(picture)"> ลบอัลบั้มเพลง</button>
